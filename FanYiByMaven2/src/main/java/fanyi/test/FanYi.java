...
public class FanYi extends javax.swing.JFrame {
    ...
    public FanYi() {
        tempFile = new File("D:\\微云同步助手\\1994468521\\NetBeansProjects\\zed-translation\\zed-0.165.4\\zed-fy");
        fo = new FileOperator();
        zhengZes = new Vector<>();
        repMap = new HashMap<>();
        mFanYi = new MFanYi();
...
//                }
    ...
    private void initComponents() {
        ...
        jTextField3.setText("D:\\微云同步助手\\1994468521\\NetBeansProjects\\zed-translation\\zed-0.165.4\\zed-src\\zed-0.165.4\\crates");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JFileChooser fileChooser = new JFileChooser(tempFile.getParent());
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            tempFile = ProFile;
            this.setTitle(tempFile.getAbsolutePath());
            //加载工程文件
    ...
    private Vector<MReplace> CheckOneRow(DefaultTableModel tableModel, int index, DefaultTableModel tableModel2, String col2Data, Vector<MReplace> reps) {
        ...
        SwingUtilities.invokeLater(() -> tableModel.setValueAt(data3, index, 2));
        return rev;
    }
     ...
     * 检查文件是否存在匹配项
     */
    public boolean containsString(File filePath, String targetString) {
        System.out.println("努力找文件==>" + filePath.getName());
        return fo.containsString(filePath.getAbsolutePath(), targetString);
    }
